                ...
                <div class="card-body">
                    <form id="productCreateForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="image" class="font-weight-bold">@lang('Image') (500x370)</label>
...
<script>
    (function ($) {
        ...
        $('#productCreateForm').submit(function(e) {
            ...
            xhr.open("POST", "{{route('admin.service.store')}}");
                ...
                if (xhr.status === 200) {
                   ...
                   loadingSpinnerWrapper.fadeOut();
                    ...
                    if (xhr.status === 500) {
                        loadingSpinnerWrapper.fadeOut();
                        spinnerPercentage.text('0%').fadeOut();
                            errorMessage = 'service could not be created. Please try again later.';
                        ...
                        loadingSpinnerWrapper.fadeOut();
                        spinnerPercentage.text('0%').fadeOut();
                        var errorMessage = 'service could not be created. Please try again later.';
                        Toast.fire({
                            icon: 'error',
                            title: errorMessage
                        });

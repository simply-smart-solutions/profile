        ...
        Route::middleware(['check.status'])->group(function () {
            ...
            Route::middleware('registration.complete')->group(function(){
                ...
                Route::controller('WithdrawController')->group(function(){
                    Route::get('withdraw-method', 'withdrawMethod')->name('withdraw.method');
                    Route::post('withdraw-request', 'withdrawStore')->name('withdraw.money');
                    Route::post('withdraw-request/confirm', 'withdrawSubmit')->name('withdraw.submit');

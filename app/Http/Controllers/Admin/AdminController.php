...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $order['total_approved'] = Order::where('status',2)->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'withdrawalsChart', 'depositsChart', 'deposit', 'withdrawals', 'userLogins', 'newTickets','order'));
    }

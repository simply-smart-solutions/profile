...
function getProductShareLinks($productId)
  {
      ...
      $shareLinks = [
          ...
          'twitter' => 'https://twitter.com/intent/tweet?url=' . urlencode($productUrl),
          'linkedin' => 'https://www.linkedin.com/shareArticle?url=' . urlencode($productUrl),
          'instagram' => 'https://www.instagram.com/share?url=' . urlencode($productUrl)
      ];
  ...
  function calculateAverageRating($averageRating)
{
    ...
    $ratingHtml = '<div class="ratings-box">';
...
function generateRatingStars($rating) {
    ...
    for ($i = 1; $i <= 5; $i++) {
      if ($i <= $rating) {
        $starsHTML .= '<li class="rating-list__item"><i class="fas fa-star"></i></li>';
      } else {
        $starsHTML .= '<li class="rating-list__item"><i class="far fa-star"></i></li>';
      }
    }

    return '<ul class="rating-list mb-2">' . $starsHTML . '</ul>';
  }
 ...
 function getTotalSales($productId)
{

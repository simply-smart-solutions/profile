...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('manage/users')->group(function(){
     ...
     Route::controller('ProductController')->name('product.')->prefix('products')->group(function () {
        ...
        Route::post('update', 'update')->name('update');
        Route::post('image/remove', 'imageRemove')->name('image.delete');
        Route::get('delete', 'delete')->name('delete');

        Route::get('/pending', 'pendingProduct')->name('pending');
        Route::get('/approve', 'approveProduct')->name('approve');

        Route::get('/single-approve/{id}', 'approveSingleProduct')->name('single.approve');
        Route::get('/single-reject/{id}', 'rejectSingleProduct')->name('single.reject');

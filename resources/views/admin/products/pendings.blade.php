            ...
            <div class="card-body p-0">
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light style--two custom-data-table">
                        ...
                        <tbody>
                           @forelse ($pendingProducts as $item)
                           <tr>
                              <td>{{__($item->name)}}</td>
                            ...
                            <td> @if(isset($item->discount))
                              ...
                              <td>
                                 <div class="button--group">
                                    <a href="{{route('admin.product.single.approve',$item->id)}}"  class="btn btn-sm btn--warning" title="Approve"><i class="las la-check"></i></a>
